...
```
git clone https://github.com/yaswanthteja/Learn_Docker
cd  examples
```
...
```
    ...
    Successfully tagged username/my-first-docker-image:latest
```
...
The push refers to repository [docker.io/username/my-first-docker-image]
896818320e80: Pushed
b8088c305a52: Pushed
69dd4ccec1a0: Pushed
